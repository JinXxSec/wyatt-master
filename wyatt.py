...
#   .__                   __   .__                                    .__  _____.__ 
   |  |__ _____    ____ |  | _|__| ____    ____  __ ___________  _  _|__|/ ____\__|
   |  |  \\__  \ _/ ___\|  |/ /  |/    \  / ___\|  |  \_  __ \ \/ \/ /  \   __\|  |
   |   Y  \/ __ \\  \___|    <|  |   |  \/ /_/  >  |  /|  | \/\     /|  ||  |  |  |
   |___|  (____  /\___  >__|_ \__|___|  /\___  /|____/ |__|    \/\_/ |__||__|  |__|
        \/     \/     \/     \/       \//_____/                                    
...
configFile = installDir + "/wyatt.cfg"
...
toolDir = installDir + config.get('wyatt', 'toolDir')

logDir = installDir + config.get('wyatt', 'logDir')

yes = config.get('wyatt', 'yes').split()
...
def agreement():
    ...
    while not config.getboolean("wyatt", "agreement"):
        ...
        if agree in yes:
            ...
            config.set('wyatt', 'agreement', 'true')
